...
df_print: kable
vignette: |
  %\VignetteIndexEntry{Bob Ross' Joy of Painting}
...
* the most frequent connection are `tree | trees`, `tree | lake`, `lake | mountain`, which makes sense as seen with the correlation plot.
