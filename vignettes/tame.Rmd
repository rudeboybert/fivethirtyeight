...
Building off this precedent, we created the `fivethirtyeight` R package of data and code behind the stories and interactive visualizations at [FiveThirtyEight.com](http://www.FiveThirtyEight.com). All with the goal of providing the novice student a "low barrier to entry" to exploring datasets that satisfy the 3 R's, we
