...
historical_raptor_by_player <- historical_raptor_by_player[c("era","player_name","player_id","season","poss","mp","raptor_box_offense","raptor_box_defense","raptor_box_total",    
...
modern_raptor_by_player <- modern_raptor_by_player[c("era","player_name","player_id","season","poss","mp","raptor_box_offense","raptor_box_defense","raptor_box_total",    
                                                             "raptor_onoff_offense","raptor_onoff_defense","raptor_onoff_total","raptor_offense","raptor_defense","raptor_total",
                                                             "war_total","war_reg_season","war_playoffs","predator_offense","predator_defense","predator_total",
                                                             "pace_impact")] %>%
  mutate_all(as.character)
...
historical_raptor_by_team[c("raptor_box_offense", "raptor_box_defense","raptor_box_total", 
            "raptor_onoff_offense", "raptor_onoff_defense", "raptor_onoff_total")] <- NA
historical_raptor_by_team <- historical_raptor_by_team[c("era","player_name","player_id","season","season_type","team","poss","mp","raptor_box_offense","raptor_box_defense","raptor_box_total",    
                                                             "raptor_onoff_offense","raptor_onoff_defense","raptor_onoff_total","raptor_offense","raptor_defense","raptor_total",
                                                             "war_total","war_reg_season","war_playoffs","predator_offense","predator_defense","predator_total",
                                                             "pace_impact")] %>%
  mutate_all(as.character)
...
modern_raptor_by_team <- modern_raptor_by_team[c("era","player_name","player_id","season","season_type","team","poss","mp","raptor_box_offense","raptor_box_defense","raptor_box_total",    
                                                         "raptor_onoff_offense","raptor_onoff_defense","raptor_onoff_total","raptor_offense","raptor_defense","raptor_total",
                                                         "war_total","war_reg_season","war_playoffs","predator_offense","predator_defense","predator_total",
                                                         "pace_impact")] %>%
  mutate_all(as.character)
