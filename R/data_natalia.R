...
#'
#' @format A data frame with 972 rows representing weeks of cable coverage and 7 variables:
#' \describe{
...
#' \url{https://fivethirtyeight.com/features/beto-orourke-ignored-cable-news-and-it-ignored-him/}
#'
#' @format A data frame with 954 rows representing weeks and 6 variables:
#' \describe{
#'   \item{date}{start date for the week of coverage}
#'   \item{name}{candidate's name}
