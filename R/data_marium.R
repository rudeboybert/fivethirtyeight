...
#' 
#' @format A data frame with 50 rows representing the 50 U.S. states and 5 variables:
#' \describe{
...
#' \url{https://fivethirtyeight.com/features/what-americas-governors-are-talking-about/}
#' 
#' @format A data frame with 2,223 rows representing phrases and 9 variables:
#' \describe{
