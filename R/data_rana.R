...
#'   \item{player_id}{Player's Baseball-Reference.com ID}
#'   \item{year_id}{Season}
#'   \item{team_id}{Baseball-Reference ID of team}
#'   \item{lg_id}{League of teaml}
#'   \item{pct_pt}{Share of total team playing time (measured by plate appearances and leverage-weighted innings) for playe}
#'   \item{WAR162}{Wins Above Replacement per 162 team games, averaging B-R and FG WAR}
#'   \item{def_pos}{Defensive positions played, in order of innings/games. (Will not include DH or any position for players with 0 PA.)}
...
#'   \item{prev_franch}{Previous franchise played for (NULL if player debuted for team)}
#'   \item{year_acq}{First season for player with that franchise}
#'   \item{year_left}{Last season for player with that franchise}
#'   \item{next_franch}{Next franchise played for (NULL if player retired with or is currently on team)}
#'   }
